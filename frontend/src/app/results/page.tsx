...
export default function Results() {
  return (
    <div className="h-screen">
      <div className="h-24 bg-sky-900" />
      <SearchBar className="left-12 top-14 absolute shadow-[0px_0px_10px_0px_rgba(51,51,51,0.10)] w-6xl" />
        ...
        <div className="inline-flex flex-col justify-between items-start">
          <div className="self-stretch flex flex-col justify-start items-start gap-4">
            <div className="self-stretch inline-flex justify-start items-center gap-2">
              <div className="justify-start text-zinc-800 text-base font-bold leading-tight">
                Trending Searches
              </div>
            </div>
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
