            ...
            <div className="flex items-center gap-2">
              <Link href="/admin/dashboard" className="flex items-center gap-2">
                <Image
                  ...
                  className="h-10 w-10"
                />
                <span className="hidden font-bold text-wr-navy md:inline-block">World Records</span>
              </Link>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" className="gap-1 text-wr-navy">
              <Lightbulb className="h-4 w-4" />
              <span className="hidden md:inline-block">Inspirations</span>
            </Button>
            <UserNav />
          </div>
        </div>
      ...
      <div className="flex flex-1">
        <aside className="hidden w-64 border-r bg-white md:block">
          <div className="flex h-full flex-col gap-2 p-4">
            ...
            <div className="rounded-lg bg-wr-navy/10 p-4">
              <div className="flex items-center gap-2">
